...
void getInputAndPrintSymbol();  ///This function gets input from the player and print the symbol of the player where he chose
...
void victoryPlayer(int count);   ///This function check if one of the players win. The function prints announcement accordingly.
